...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String USERNAME_TABLE_CREATE = "CREATE TABLE "
            ...
            + UserDao.COLUMN_NAME_MTOOL_ID + " TEXT, "
    ...
    private static final String AT_SUPPORT_NESSAGE_TABLE_CREATE = "CREATE TABLE "
            + AtSupportMessageDao.TABLE_NAME + " ("
            + AtSupportMessageDao.COLUMN_NAME_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
            + AtSupportMessageDao.COLUMN_NAME_STATE_ID + " INTEGER, "
            + AtSupportMessageDao.COLUMN_NAME_ACTION_TYPE + " INTEGER, "
            + AtSupportMessageDao.COLUMN_NAME_AT_TYPE + " INTEGER, "
            + AtSupportMessageDao.COLUMN_NAME_SUPPORT_TYPE + " INTEGER, "
            + AtSupportMessageDao.COLUMN_NAME_READ_FLAG + " INTEGER, "
            + AtSupportMessageDao.COLUMN_NAME_PIC_URL + " TEXT, "
            + AtSupportMessageDao.COLUMN_NAME_NICK + " TEXT, "
            + AtSupportMessageDao.COLUMN_NAME_REASON + " TEXT, "
            + AtSupportMessageDao.COLUMN_NAME_TIME + " TEXT, "
            + AtSupportMessageDao.COLUMN_NAME_FROM + " TEXT); ";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(AT_SUPPORT_NESSAGE_TABLE_CREATE);
    }
