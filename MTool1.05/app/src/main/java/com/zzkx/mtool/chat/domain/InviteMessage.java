...
public class InviteMessage {
	...
	public enum InviteMessageStatus {
		...
		/**current user del black list in other device **/
		...
		/**current user del some one into group black list in other device*/
		MULTI_DEVICE_GROUP_BAN,
		/**current user remove some one from group black list in other device*/
		MULTI_DEVICE_GROUP_ALLOW,
		/**current user block group searchMessage in other device*/
		MULTI_DEVICE_GROUP_BLOCK,
		/**current user unblock group searchMessage in other device*/
		...
		/**current user del group admin in other device*/
