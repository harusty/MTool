 ...
 */
public class CallOptionActivity extends ChatBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle arg0) {
        ...
        // EMClient.getInstance().callManager().getTotalOptions().xxx set initial values resident at DemoHelper
