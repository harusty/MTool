...
public class ChatRoomDetailsActivity extends ChatBaseActivity implements OnClickListener {
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.rl_change_chatroom_name:
				startActivityForResult(new Intent(this, EditActivity.class).putExtra("data", room.getName()).putExtra("title", "edit chat room searchName").
