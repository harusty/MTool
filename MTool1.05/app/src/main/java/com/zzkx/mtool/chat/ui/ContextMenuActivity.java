...
public class ContextMenuActivity extends ChatBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		EMMessage message = getIntent().getParcelableExtra("searchMessage");
		boolean isChatroom = getIntent().getBooleanExtra("ischatroom", false); 
		
//		int type = message.getType().ordinal();
//		if (type == EMMessage.Type.TXT.ordinal()) {
//		    if(message.getBooleanAttribute(EaseConstantSub.MESSAGE_ATTR_IS_VIDEO_CALL, false)
//					|| message.getBooleanAttribute(EaseConstantSub.MESSAGE_ATTR_IS_VOICE_CALL, false)){
//
//				setContentView(R.layout.em_context_menu_for_location);
//		    }else if(message.getBooleanAttribute(EaseConstantSub.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
