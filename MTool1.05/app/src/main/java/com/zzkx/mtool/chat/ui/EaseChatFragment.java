...
import com.zzkx.mtool.view.activity.LocateShareMapActivity;
 ...
 */
public abstract class EaseChatFragment extends EaseBaseFragment implements EMMessageListener, IBaseFragment {
    protected static final String TAG = "EaseChatFragment";
    protected static final int REQUEST_CODE_MAP = 1;
    protected static final int REQUEST_CODE_CAMERA = 2;
    protected static final int REQUEST_CODE_LOCAL = 3;
    protected static final int REQUEST_CODE_BUSINESS_CARD = 4;
    protected static final int REQUEST_CODE_COLLECTION = 5;
    ...
    protected int[] itemStrings = {R.string.attach_picture, R.string.attach_take_pic, R.string.collect, R.string.mingpain, R.string.attach_location};
    protected int[] itemdrawables = {R.drawable.ease_chat_image_selector, R.drawable.ease_chat_takepic_selector,
            R.drawable.ic_collect, R.drawable.ic_mingpian, R.drawable.ease_chat_location_selector};

    protected int[] itemIds = {ITEM_PICTURE, ITEM_TAKE_PICTURE, ITEM_COLLECT, ITEM_MINGPIAN, ITEM_LOCATION};
...
//        messageList.setAvatarShape(1);
        ...
        swipeRefreshLayout.setColorSchemeResources(com.zzkx.mtool.R.color.colorPrimary);
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            public void onResendClick(final EMMessage message) {
                ...
                new DialogResend(getActivity(), new DialogResend.OnConfrimListener() {
                    @Override
...
//                        }
                ...
                case REQUEST_CODE_MAP:
                    ...
                    break;
                case REQUEST_CODE_BUSINESS_CARD:
                case REQUEST_CODE_COLLECTION:
                    String collectInfoJson = data.getStringExtra(Const.SHARE_INFO);
                    sendShareMessage(collectInfoJson);
                    break;
            }
        }
    }
    ...
    public abstract void onOrderStateChanged(int orderType);
    ...
    public void onMessageReceived(List<EMMessage> messages) {
        ...
        for (EMMessage message : messages) {
            ...
            try {
                ...
                onOrderStateChanged(Integer.parseInt(status));
            } catch (HyphenateException e) {
                e.printStackTrace();
                Log.e(TAG, "NO Status");
            }
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_PICTURE:
                    ...
                    break;
                case ITEM_COLLECT:
                    startActivityForResult(new Intent(getContext(), CollectActivity.class)
                            .putExtra(Const.SELECT_ACTION, true), REQUEST_CODE_COLLECTION);
                    break;
                case ITEM_MINGPIAN:
                    startActivityForResult(new Intent(getActivity(), FriendListActivity.class), REQUEST_CODE_BUSINESS_CARD);
                    break;
                case ITEM_LOCATION:
                    startActivityForResult(new Intent(getActivity(), LocateShareMapActivity.class), REQUEST_CODE_MAP);
                    break;
                default:
            }
        }
    ...
    protected void sendShareMessage(String json) {
        String content = null;
    ...
    /**
     * send @ searchMessage, only support group chat searchMessage
     *
     * @param content
     */
    ...
    private void sendAtMessage(String content) {
        if (chatType != EaseConstant.CHATTYPE_GROUP) {
            EMLog.e(TAG, "only support group chat searchMessage");
            return;
        }
        EMMessage message = EMMessage.createTxtSendMessage(content, toChatUsername);
        EMGroup group = EMClient.getInstance().groupManager().getGroup(toChatUsername);
