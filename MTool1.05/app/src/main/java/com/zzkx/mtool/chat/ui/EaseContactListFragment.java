...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    private DialogInitialNab mInitialDialog;
    private View mRedArrow;
    ...
    protected void initView() {
        contentContainer = (RelativeLayout) getView().findViewById(R.id.content_container);
        ...
        mRedArrow = getView().findViewById(R.id.icon_red_arrow);
        mRedArrow.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                mInitialDialog.show(mRedArrow);
            }
        });

        mInitialDialog = new DialogInitialNab(getContext());
        mInitialDialog.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String headerString = (String) view.getTag();
                ListView listView = contactListLayout.getListView();
                SectionIndexer indexer = (SectionIndexer) listView.getAdapter();
