...
@SuppressLint("NewApi")
public class EaseMainActivity2 extends ChatBaseActivity {

    protected static final String TAG = "MainActivity";
    // textview for unread searchMessage count
    private TextView unreadLabel;
    // textview for unread event searchMessage
    ...
    EMClientListener clientListener = new EMClientListener() {
        ...
        public void onMigrate2x(boolean success) {
            Toast.makeText(EaseMainActivity2.this, "onUpgradeFrom 2.x to 3.x " + (success ? "success" : "fail"), Toast.LENGTH_LONG).show();
            if (success) {
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals(EaseConstantSub.ACTION_GROUP_CHANAGED)) {
                    if (EaseCommonUtils.getTopActivity(EaseMainActivity2.this).equals(GroupsActivity.class.getName())) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    if (ChatActivity.activityInstance != null && ChatActivity.activityInstance.toChatUsername != null &&
                        ...
                        Toast.makeText(EaseMainActivity2.this, ChatActivity.activityInstance.getToChatUsername() + st10, Toast.LENGTH_LONG)
                                .show();
...
//	}
    ...
    private void showExceptionDialog(String exceptionType) {
        ...
        if (!EaseMainActivity2.this.isFinishing()) {
            // clear up global variables
            try {
                if (exceptionBuilder == null)
                    exceptionBuilder = new android.app.AlertDialog.Builder(EaseMainActivity2.this);
                ...
                exceptionBuilder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        isExceptionDialogShow = false;
                        finish();
                        Intent intent = new Intent(EaseMainActivity2.this, LoginActivity.class);
                ...
                DemoHelper.getInstance().logout(false, new EMCallBack() {
                    ...
                    public void onSuccess() {
                        runOnUiThread(new Runnable() {
                            public void run() {
                                finish();
                                startActivity(new Intent(EaseMainActivity2.this, ChatLoginActivity.class));
                            }
                        });
                    }
