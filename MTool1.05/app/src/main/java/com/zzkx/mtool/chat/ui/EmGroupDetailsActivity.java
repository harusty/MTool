...
public class EmGroupDetailsActivity extends ChatBaseActivity implements OnClickListener {
    ...
    public static EmGroupDetailsActivity instance;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (progressDialog == null) {
                progressDialog = new ProgressDialog(EmGroupDetailsActivity.this);
    ...
    private void refreshMembersAdapter() {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                membersAdapter = new GridAdapter(EmGroupDetailsActivity.this, R.layout.em_grid_owner, new ArrayList<String>());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.clear_all_history: // 清空聊天记录
                ...
                new EaseAlertDialog(EmGroupDetailsActivity.this, null, st9, null, new AlertDialogUser() {
    ...
    private void showAnnouncementDialog() {
        ...
        if (group.getOwner().equals(EMClient.getInstance().getCurrentUser()) ||
            ...
            final EditText et = new EditText(EmGroupDetailsActivity.this);
            et.setText(group.getAnnouncement());
            et.setText("sdfsaddfasdfasdfafdasdsadfsad");
            builder.setView(et);
                ...
                new EMCallBack() {
                    ...
                    public void onError(int code, final String error) {
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                progressDialog.dismiss();
                                Toast.makeText(EmGroupDetailsActivity.this, "update fail," + error, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            progressDialog.dismiss();
                            Toast.makeText(EmGroupDetailsActivity.this, "progress failed", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
                            ...
                            public void run() {
                                try {
                                    ...
                                    runOnUiThread(new Runnable() {
                                                      @Override
                                                      public void run() {
                                                          Toast.makeText(EmGroupDetailsActivity.this, e.getDescription(), Toast.LENGTH_SHORT).show();
                                                      }
                                                  }
                                    );
                                    e.printStackTrace();
    ...
    private class OwnerAdminAdapter extends ArrayAdapter<String> {
        ...
        public View getView(final int position, View convertView, final ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.textView = (TextView) convertView.findViewById(R.id.tv_section);
            ...
            button.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MemberMenuDialog dialog = new MemberMenuDialog(EmGroupDetailsActivity.this);
                    dialog.show();
                    ...
                    button.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            startActivityForResult(
                                    (new Intent(EmGroupDetailsActivity.this, GroupPickContactsActivity.class).putExtra("groupId", groupId)),
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    System.out.println("Announcement2: "+group.getAnnouncement());
                    runOnUiThread(new Runnable() {
                        public void run() {
    ...
    private class GroupChangeListener extends EaseGroupListener {
        ...
        public void onOwnerChanged(String groupId, String newOwner, String oldOwner) {
            runOnUiThread(new Runnable() {
                ...
                @Override
                public void run() {
                    Toast.makeText(EmGroupDetailsActivity.this, "onOwnerChanged", Toast.LENGTH_LONG).show();
                }
            });
            updateGroup();
        }
        ...
        public void onAnnouncementChanged(String groupId, final String announcement) {
            if (groupId.equals(EmGroupDetailsActivity.this.groupId)) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        announcementText.setText(announcement);
        ...
        public void onSharedFileAdded(String groupId, final EMMucSharedFile sharedFile) {
            if (groupId.equals(EmGroupDetailsActivity.this.groupId)) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(EmGroupDetailsActivity.this, "Group added a share file", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }
        ...
        public void onSharedFileDeleted(String groupId, String fileId) {
            if (groupId.equals(EmGroupDetailsActivity.this.groupId)) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(EmGroupDetailsActivity.this, "Group deleted a share file", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }
