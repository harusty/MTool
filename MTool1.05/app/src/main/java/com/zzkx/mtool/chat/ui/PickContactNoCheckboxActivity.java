...
public class PickContactNoCheckboxActivity extends ChatBaseActivity {
	...
	private void getContactList() {
		...
		for (Entry<String, EaseUser> entry : users.entrySet()) {
			if (!entry.getKey().equals(EaseConstantSub.NEW_FRIENDS_USERNAME) && !entry.getKey().equals(EaseConstantSub.GROUP_USERNAME) && !entry.getKey().equals(EaseConstantSub.CHAT_ROOM) && !entry.getKey().equals(EaseConstantSub.CHAT_ROBOT))
