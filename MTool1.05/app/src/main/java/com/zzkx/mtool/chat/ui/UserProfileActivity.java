...
public class UserProfileActivity extends ChatBaseActivity implements OnClickListener {
            ...
            public void onSuccess(EaseUser user) {
                if (user != null) {
                    ...
                    if (!TextUtils.isEmpty(user.getAvatar())) {
                        Glide.with(UserProfileActivity.this).load(user.getAvatar()).placeholder(R.drawable.ease_default_avatar).into(headAvatar);
                    } else {
                        Glide.with(UserProfileActivity.this).load(R.drawable.ease_default_avatar).into(headAvatar);
                    }
                }
            }
