...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        muteImage = (TextView) findViewById(R.id.iv_mute);
        handsFreeImage = (TextView) findViewById(R.id.iv_handsfree);
...
//		nickTextView.setText(username);
        ...
        EaseUserUtils.setUserNick(this, username, nickTextView);
        ...
        if (!isInComingCall) {// outgoing call
            ...
            findViewById(R.id.view_cancle).setOnClickListener(new OnClickListener() {
                @Override
            ...
            System.out.println("callExt:"+callExt);
            findViewById(R.id.view_cancle).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    refuseBtn.performClick();
                }
            });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_handsfree:
                if (isHandsfreeState) {
                    handsFreeImage.setText("免提");
                    closeSpeakerOn();
                    isHandsfreeState = false;
                } else {
                    handsFreeImage.setText("关闭免提");
                    openSpeakerOn();
