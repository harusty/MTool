...
public class ImageCache {
			...
			mMemoryCache = new LruCache<String, BitmapDrawable>(
				...
				protected void entryRemoved(boolean evicted, String key,
					...
					if (RecyclingBitmapDrawable.class.isInstance(oldValue)) {
						...
						if (Utils.hasHoneycomb()) {
							// We're running on Honeycomb or later, so del the
							// bitmap
	 ...
	 *            The context to use
	 * @param uniqueName
	 *            A unique directory searchName to append to the cache dir
...
//		}
	...
	private static RetainFragment findOrCreateRetainFragment(FragmentManager fm) {
		...
		// If not retained (or first time running), we need to create and del
		// it.
