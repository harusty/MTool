...
public class CommentSendPresenter extends BasePresenter<ISendCommentView, BaseBean> {

    private RequestBean mLastRequest;

    public CommentSendPresenter(ISendCommentView view) {
        super(view);
    }
    ...
    public void send(RequestBean requestBean) {
        ...
        getHttpModel().request(API.REPLY, mLastRequest);
    }
}
