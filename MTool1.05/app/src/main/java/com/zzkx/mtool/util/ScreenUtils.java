...
public class ScreenUtils {
     ...
     * <p>
     * 获得状态栏的高度
     * 这里还有另外一种方法，大家都知道Android的所有资源都会有惟一标识在R类中作为引用。
     * 我们也可以通过反射获取R类的实例域，代码如下
     *
     * @param context
     * @return
     */
     ...
     * 方法二:
     * <p>
     * 在应用开发中，有时我们需要用代码计算布局的高度，可能需要减去状态栏(status bar)的高度。
     * 状态栏高度定义在Android系统尺寸资源中status_bar_height,但这并不是公开可直接使用的，
     * 例如像通常使用系统资源那样android.R.dimen.status_bar_height。但是系统给我们提供了一个Resource类，
     * 通过这个类我们可以获取资源文件
     *
     * @param context
     * @return
