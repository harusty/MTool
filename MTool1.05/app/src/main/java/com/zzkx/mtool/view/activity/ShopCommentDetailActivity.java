...
import com.zzkx.mtool.view.fragment.ShopCommentReplyFragment;
import com.zzkx.mtool.view.fragment.ShopCommentDetailFragment;
...
public class ShopCommentDetailActivity extends BaseActivity {
    ...
    private ShopCommentDetailFragment mStateDetailFragment;
    ...
    private void initPager() {
        ...
        mStateDetailFragment = new ShopCommentDetailFragment();
        mStateDetailFragment.setArguments(getIntent().getExtras());
        ShopCommentReplyFragment commentFragment = new ShopCommentReplyFragment();
