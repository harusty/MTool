...
public class DialogContactTagsList {
    ...
    private List<ContactTagBean.DataBean> mSelectList;
    private BaseCollectBean mItem;

    public DialogContactTagsList(Context context, View.OnClickListener confrimClickListener) {
    ...
    public void show(int action, BaseCollectBean item) {
        ...
        for (int i = 0; i < mData.size(); i++) {
            ContactTagBean.DataBean dataBean = mData.get(i);
    ...
    public void setData(final List<ContactTagBean.DataBean> data) {
        ...
        mAdapter = new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                ContactTagBean.DataBean dataBean = mData.get(position);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (mLastPosition != -1 && mLastPosition != position && !mMultiSelect) {
                    ContactTagBean.DataBean lastBean = mData.get(mLastPosition);
    ...
    public List<ContactTagBean.DataBean> getSelectList() {
        if (mSelectList == null)
