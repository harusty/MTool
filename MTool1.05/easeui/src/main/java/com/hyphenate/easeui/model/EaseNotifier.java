...
public class EaseNotifier {
    ...
    protected void sendNotification(EMMessage message, boolean isForeground, boolean numIncrease) {
        ...
        try {
            ...
            if (notificationInfoProvider != null && notificationInfoProvider.getNotifyInfoShow()) {
                // lastest text
...
//                    .setDefaults(NotificationCompat.DEFAULT_ALL)
            ...
            if (isForeground) {
                ...
                //切到桌面后，必须要设置setDefaults方法才能弹出弹框（为了单独控制消息提示音，在这先设置default_vibrate）
